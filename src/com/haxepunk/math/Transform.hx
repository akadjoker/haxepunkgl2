...
class Transform
{
	...
	public function getLocalToWorldMatrix():Matrix
    {
            ...
            {
			//return Util.MatrixMult( parent.getTransformationMatrix(),getTransformationMatrix());
			return Util.MatrixMult( getTransformationMatrix(),parent.getTransformationMatrix());
            }
