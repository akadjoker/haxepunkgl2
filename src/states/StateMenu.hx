...
class StateMenu extends BasicGameState
{
	...
	public override function begin()
	{
		...
		alpha = new AlphaAction(0,1,false,2);
		...
		*/
		...
		a_b.addAction(new ScaleAction(1.5,0,false,0.6,Ease.elasticOut));
		add(a_b);
		...
		a_c.addAction(new ScaleAction(0.8,0,false,0.6,Ease.elasticOut));
		add(a_c);
