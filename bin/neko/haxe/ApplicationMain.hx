...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("flashpunk", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("flashpunk", null, 480, 320);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["build"] = "139";
		app.meta["company"] = "djoker soft";
		app.meta["file"] = "flashpunk";
		app.meta["name"] = "flashpunk";
		app.meta["packageName"] = "com.flashpunk.glteste";
		...
		app.window.context.attributes.background = 16086510;
